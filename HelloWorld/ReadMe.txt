========================================================================
    ACTIVE TEMPLATE LIBRARY : HelloWorld 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 만든 이 HelloWorld 프로젝트는 DLL(동적 연결 라이브러리)를 작성하는 데 기초로
사용할 수 있습니다.
...
HelloWorld.idl
    ...
    이 파일은 MIDL 컴파일러에 의해 처리되어 다음을 생성합니다.
        C++ 인터페이스 정의 및 GUID 선언         (HelloWorld.h)
        GUID 정의                        (HelloWorld_i.c)
        형식 라이브러리                       (HelloWorld.tlb)
        마샬링 코드                         (HelloWorld_p.c 및 dlldata.c)

HelloWorld.h
    이 파일에는 HelloWorld.idl에서 정의된 항목의 C++ 인터페이스 정의 및
...
HelloWorldps.vcxproj
    ...
    HelloWorld_i.c 및 HelloWorld_p.c가 생성됩니다.
